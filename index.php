...
<div class="page">
    <header>
        <h1 class="heading">Best Anime</h1>
        <div class="subheading">On this page titles were sorted by its rating</div>
    </header>
    <div class="main">
        <div class="titles">
            <?php
            $sql = 'select anime_id, title, release_year, type, image from anime order by rating desc';
